...
function createBarrier() {
    for (let i = 0; i <= 10; i++) {
        $("#barrier4").append("<div class='barrier4' style='margin-left: " + barrierMarginLeft + "px' id='barrier4" + i + "'></div>");
...
function barrierAnimation() {
    for (let i = 0; i < 6; i++) {
        let css = parseInt($("#barrier4" + i).css("margin-left"));

        let newMarginLeft = css - 25;
        $("#barrier4" + i).css("margin-left", newMarginLeft - 25 + "px")
